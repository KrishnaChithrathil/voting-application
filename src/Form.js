...
export class Forms extends React.Component {
  ...
  pageSubmit = (e) => {
    ...
    let NewsubjectObjectWithNameDescription = { subject: this.state.sub, describe:this.state.description, count: 0, id:Date.now(), status: 'Inactive' }
      ...
      <div className="form-group">
        <form >
          <div>
            ...
            <p className="validation" style={{ color: "red" }}>{this.state.suberr}</p>
          </div>
          <div>
